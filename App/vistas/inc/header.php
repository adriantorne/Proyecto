...
<nav class="navbar navbar-expand-lg navbar-light bg-dark text-white">
  ...
  <a class="navbar-brand fw-bold text-white " href="https://cpifpbajoaragon.com/"><img style="width:30px;" class="logo-default" src="<?php echo RUTA_URL?>../imagenes/logo2.png"> CPIFP BAJO ARAGON</a>
